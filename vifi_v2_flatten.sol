...
contract VARQ is Ownable {
    ...
    function convertTokensToVUSD(uint256 vRTAmount) public {
        uint256 burnCBrate = vTTD.totalSupply() / vRT.totalSupply();
        uint256 vTTDAmount = vRTAmount * burnCBrate;
        
        require(vTTDAmount / burnCBrate == vRTAmount, "Amounts mismatch");
