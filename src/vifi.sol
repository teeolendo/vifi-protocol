...
contract ViFi_DAO is Ownable {
    ...
    constructor(address _mUSDCAddress, address owner) Ownable(owner) {
        vUSD = new vToken("Virtual USD", "vUSD", owner);
        vTTD = new vToken("Virtual Trinidad Tobago Dollars", "vTTD", owner);
        vRT = new vToken("Virtual Reserve Token", "vRT", owner);
